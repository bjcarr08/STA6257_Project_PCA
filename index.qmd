...
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#EAEAD6', 'nodeBorder': '#8B814C', 'lineColor': '#8B814C', 'primaryTextColor': '#191970', 'textColor': '#191970', 'fontSize': '12px', 'width': '100%'}}}%%

flowchart LR
A[(Clean<br/>Data)] --> B(Estimate<br/>Sample<br/>Mean<br/>Vector)
B --> C((Are all<br/>variables the<br/>same scale or<br/>units?))
C --- D((Yes))
C --- E((No))
D --> G(Estimate<br/>Sample<br/>Covariance<br/>Matrix)
E -.- F(Standardize<br/>Data)
E --> H(Estimate<br/>Sample<br/>Correlation<br/>Matrix)
F -.- G
